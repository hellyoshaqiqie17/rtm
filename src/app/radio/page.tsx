    ...
    <div className="space-y-8 py-6 px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto font-sans selection:bg-[#E50914] selection:text-white">
      ...
      <div className="border-b border-white/10 pb-5">
        <div className="flex items-center gap-2 text-xs font-mono font-bold text-[#E50914] uppercase tracking-wider">
          ...
          <span>SIARAN RADIO ONLINE 24 JAM</span>
        </div>
        <h1 className="text-3xl font-extrabold text-white tracking-tight mt-1 font-sans">
          Radio RTM Online
        </h1>
        <p className="text-sm text-neutral-400 mt-1">
          Dengarkan siaran langsung stasiun radio RTM MAUBERE secara jernih dari mana saja.
        </p>
      </div>
      ...
      <div className="bg-[#121212] p-6 rounded-2xl border border-white/5 space-y-3 font-sans">
        <h3 className="font-extrabold text-white text-base flex items-center gap-2">
          <Radio className="w-5 h-5 text-[#E50914]" /> Tentang Radio RTM MAUBERE
        </h3>
        <p className="text-xs text-neutral-300 leading-relaxed">
          Siaran radio nasional menyajikan informasi terkini, program musik kebudayaan daerah, berita nasional 24 jam, serta program edukasi & kesehatan untuk seluruh lapisan masyarakat.
        </p>
      </div>

      {/* Program Schedule Section */}
      <div className="pt-4">
        <ProgramSchedule defaultType="radio" />
      </div>
