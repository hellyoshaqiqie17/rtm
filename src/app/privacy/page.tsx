      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-10 border-b border-white/10 pb-6">
          ...
          <p className="text-sm text-neutral-400">
            Kebijakan privasi dan perlindungan data pengguna RTM MAUBERE.
          </p>
        </div>
        ...
        <div className="prose prose-invert prose-sm max-w-none">
          {siteSettings.privacyContent ? (
            <div
              ...
              dangerouslySetInnerHTML={{ __html: siteSettings.privacyContent }}
            />
          ) : (
            <div className="text-center py-20">
              <ShieldCheck className="w-12 h-12 text-neutral-600 mx-auto mb-4" />
              <p className="text-neutral-500 text-sm">Konten Kebijakan Privasi belum diisi.</p>
